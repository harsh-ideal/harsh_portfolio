...
import BallCanvasGroup from './canvas/Ball';
import { technologies } from "../constants";

const Tech = () => {
  return (
    <div className="flex flex-col justify-center items-center gap-10 -mb-[8rem]">
      ...
      <div className="w-[90vw] lg:w-[100vw] h-[800px] lg:h-[450px]">
        <BallCanvasGroup />
      </div>
    </div>
  );
